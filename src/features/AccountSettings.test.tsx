...
function familySession(overrides: Partial<FamilySession> = {}): FamilySession {
  return {
    ...
    respondToLoan: vi.fn().mockResolvedValue(undefined),
    createLoanRepayment: vi.fn().mockResolvedValue(undefined),
    respondToLoanRepayment: vi.fn().mockResolvedValue(undefined),
    requestReimbursementChange: vi.fn().mockResolvedValue(undefined),
    respondToReimbursementChange: vi.fn().mockResolvedValue(undefined),
    withdrawReimbursementChange: vi.fn().mockResolvedValue(undefined),

...
export const defaultData: AppData = {
  ...
  movements: [
    ...
    { id: 'seed-4', type: 'income', authorId: 'simone', memberId: 'simone', amount: 1200, date: '2026-07-01', description: 'Stipendio luglio', categoryId: 'stipendio', beneficiaryId: 'datore-lavoro', accountId: 'simone-bank', shared: false, createdAt: '2026-07-01T07:00:00.000Z' },

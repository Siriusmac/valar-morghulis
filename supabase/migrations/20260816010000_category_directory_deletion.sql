-- Estende la cancellazione sincronizzata delle anagrafiche alle categorie.
-- Il redirect viene applicato dai client anche ai parziali e alle rate future.
...
begin
  ...
  if target_record_type not in ('category', 'beneficiary', 'sender')
